...
-- Drop primary key and add it back
...
ALTER TABLE t_ds_workflow_definition ADD CONSTRAINT uniq_workflow_definition_code UNIQUE (code);

-- Drop test_flag column from tables
